                            ...
                            <TableRow>
                                <TableCell colSpan={columns.length} className="h-24 text-center dark:text-neutral-300 text-neutral-700">
                                    <div className="flex flex-col items-center justify-center py-24">
                                        <h2 className="text-base sm:text-lg dark:text-white text-neutral-800">Build Your Standout Resume!</h2>
                                        <p className="text-sm dark:text-neutral-200 text-neutral-600 pb-4">Your resume is your first impression. Make it count!.</p>
                                        <CreateDocumentModal />
                                    </div>
                                </TableCell>
                            </TableRow>
